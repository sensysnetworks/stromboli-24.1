 ...
 * 
 * ID: @(#)$Id: rtai_watchdog.c,v 1.1.1.1 2004/06/06 14:03:32 rpm Exp $
 *
 *******************************************************************************/
static char rtai_watchdog_c_id[] __attribute__ ((unused)) = "@(#)$Id: rtai_watchdog.c,v 1.1.1.1 2004/06/06 14:03:32 rpm Exp $";
...
static int OneShot = 1;			// One shot timer mode or not (periodic)
