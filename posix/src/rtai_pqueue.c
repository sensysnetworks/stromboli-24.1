...
// Id:                  @(#)$Id: rtai_pqueue.c,v 1.1.1.1 2004/06/06 14:03:03 rpm Exp $
//
...
static pthread_mutex_t pqueue_mutex = PTHREAD_MUTEX_INITIALIZER;
